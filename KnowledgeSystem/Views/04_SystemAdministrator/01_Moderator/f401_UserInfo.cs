...
namespace KnowledgeSystem.Views._04_SystemAdministrator._01_Moderator
{
    public partial class f401_UserInfo : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void EnabledController(bool _enable = true)
        {
            ...
            txbEducationName.Enabled = _enable;
        ...
        private void LockControl()
        {
            ...
            txbEducationName.Enabled = false;
        ...
        {
            lcControls = new List<LayoutControlItem>() { lcUserId, lcUserNameVN, lcUserNameTW, lcDept, lcActualJob, lcJobTitle, lcNationality, lcStatus, lcSex, lcDateStart, lcDOB, lcCCCD, lcPhone1, lcPhone2, lcAddr, lcPCName, lcRecognizedEducation, lcEducationName, lcResignDate, lcJobEffectiveDate };
            ...
            switch (eventInfo)
            {
                ...
                case EventFormInfo.View:
                    ...
                    txbEducationName.EditValue = userInfo.EducationName;
        ...
        private void btnConfirm_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            using (var handle = SplashScreenManager.ShowOverlayForm(this))
            {
                ...
                userInfo.EducationName = txbEducationName.EditValue?.ToString()?.Trim();
